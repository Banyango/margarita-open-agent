...
OLLAMA_MODEL_CONFIG: dict[str, ModelConfig] = {
    "aya-expanse": ModelConfig(think=False),
    "athene-v2": ModelConfig(think=False),
    "command-r": ModelConfig(think=False),
    "command-r7b": ModelConfig(think=False),
    "command-r7b-arabic": ModelConfig(think=False),
    "command-a": ModelConfig(think=False),
    "command-r-plus": ModelConfig(think=False),
    "firefunction-v2": ModelConfig(think=False),
    "nemotron": ModelConfig(think=False),
    "nemotron-mini": ModelConfig(think=False),
    "cogito": ModelConfig(think=False),
    "mistral-nemo": ModelConfig(think=False),
    "mistral-small": ModelConfig(think=False),
    "granite3.1-moe": ModelConfig(think=False),
    "granite3-moe": ModelConfig(think=False),
    "llama3-groq-tool-use": ModelConfig(think=False),
    "phi4-mini": ModelConfig(think=False),
    "granite3.3": ModelConfig(think=False),
    "granite3.2-vision": ModelConfig(think=False),
    "granite3.2": ModelConfig(think=False),
    "granite3.1-dense": ModelConfig(think=False),
    "granite3-dense": ModelConfig(think=False),
    "granite4.1": ModelConfig(think=False),
    "granite4": ModelConfig(think=False),
    "lfm2": ModelConfig(think=False),
    "smollm2": ModelConfig(think=False),
    "qwen2": ModelConfig(think=False),
    "qwen2.5": ModelConfig(think=False),
    "qwen2.5-coder": ModelConfig(think=False),
    "qwen3-coder-next": ModelConfig(think=False),
    "qwen3-coder": ModelConfig(think=False),
    "lfm2.5-thinking": ModelConfig(think=False),
    "ministral-3": ModelConfig(think=False),
    "ministral": ModelConfig(think=False),
    "mixtral": ModelConfig(think=False),
    "mixtral-large": ModelConfig(think=False),
    "mistral-3.1small": ModelConfig(think=False),
    "hermes3": ModelConfig(think=False),
    "devstral-small-2": ModelConfig(think=False),
    "devstral": ModelConfig(think=False),
    "kimi-k2": ModelConfig(think=False),
    "llama3.1": ModelConfig(think=False),
    "llama3.2": ModelConfig(think=False),
    "llama3.3": ModelConfig(think=False),
    "llama4": ModelConfig(think=False),
    "qwq": ModelConfig(think=False),
    "devstral-2": ModelConfig(think=False),
    "minimax-m2.1": ModelConfig(think=False),
    "mistral-large-3": ModelConfig(think=False),
    "mistral-small3.2": ModelConfig(think=False),
    "glm-ocr": ModelConfig(think=False),
    "olmo-3.1": ModelConfig(think=False),
    "functiongemma": ModelConfig(think=False),
