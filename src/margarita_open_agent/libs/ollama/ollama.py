...
OLLAMA_MODEL_CONFIG: dict[LLMModelEnum, ModelConfig] = {
    ...
    LLMModelEnum.DEEPSEEK_V3_1_671B: ModelConfig(model="deepseek-v3.1:671b", think=True),
    LLMModelEnum.DEEPSEEK_V3_2_CLOUD: ModelConfig(model="deepseek-v3.2:cloud", think=True),
    LLMModelEnum.DEEPSEEK_V4_FLASH_CLOUD: ModelConfig(model="deepseek-v4-flash:cloud", think=True),
    ...
    LLMModelEnum.QWEN3_5_397B_CLOUD: ModelConfig(model="qwen3.5:397b-cloud", think=True),
    ...
    LLMModelEnum.QWEN3_6_27B_CODING_MXFP8: ModelConfig(model="qwen3.6:27b-coding-mxfp8", think=True),
    LLMModelEnum.QWEN3_6_27B_CODING_NVFP4: ModelConfig(model="qwen3.6:27b-coding-nvfp4", think=True),
    LLMModelEnum.QWEN3_6_27B_CODING_BF16: ModelConfig(model="qwen3.6:27b-coding-bf16", think=True),
    LLMModelEnum.QWEN3_6_27B_MLX_BF16: ModelConfig(model="qwen3.6:27b-mlx-bf16", think=True),
    LLMModelEnum.QWEN3_6_35B_A3B_CODING_MXFP8: ModelConfig(model="qwen3.6:35b-a3b-coding-mxfp8", think=True),
    LLMModelEnum.QWEN3_6_35B_A3B_CODING_NVFP4: ModelConfig(model="qwen3.6:35b-a3b-coding-nvfp4", think=True),
    LLMModelEnum.QWEN3_6_35B_A3B_CODING_BF16: ModelConfig(model="qwen3.6:35b-a3b-coding-bf16", think=True),
    LLMModelEnum.QWEN3_6_35B_A3B_MLX_BF16: ModelConfig(model="qwen3.6:35b-a3b-mlx-bf16", think=True),
    ...
    LLMModelEnum.QWEN3_NEXT_80B_CLOUD: ModelConfig(model="qwen3-next:80b-cloud", think=True),
    ...
    LLMModelEnum.GLM_4_7_FLASH_Q4_K_M: ModelConfig(model="glm-4.7-flash:q4_K_M", think=True),
    LLMModelEnum.GLM_4_7_FLASH_Q8_0: ModelConfig(model="glm-4.7-flash:q8_0", think=True),
    LLMModelEnum.GLM_4_7_FLASH_BF16: ModelConfig(model="glm-4.7-flash:bf16", think=True),
    ...
    # Kimi
    LLMModelEnum.KIMI_K2_THINKING_CLOUD: ModelConfig(model="kimi-k2-thinking:cloud", think=True),
    ...
    LLMModelEnum.MINIMAX_M2_5_CLOUD: ModelConfig(model="minimax-m2.5:cloud", think=True),
    LLMModelEnum.MINIMAX_M2_7_CLOUD: ModelConfig(model="minimax-m2.7:cloud", think=True),

    # Nemotron
    LLMModelEnum.NEMOTRON_3_NANO_LATEST: ModelConfig(model="nemotron-3-nano:latest", think=True),
    LLMModelEnum.NEMOTRON_3_NANO_4B: ModelConfig(model="nemotron-3-nano:4b", think=True),
    LLMModelEnum.NEMOTRON_3_NANO_30B: ModelConfig(model="nemotron-3-nano:30b", think=True),
    LLMModelEnum.NEMOTRON_3_NANO_30B_CLOUD: ModelConfig(model="nemotron-3-nano:30b-cloud", think=True),
    LLMModelEnum.NEMOTRON_3_SUPER_LATEST: ModelConfig(model="nemotron-3-super:latest", think=True),
    LLMModelEnum.NEMOTRON_3_SUPER_120B: ModelConfig(model="nemotron-3-super:120b", think=True),
    LLMModelEnum.NEMOTRON_3_SUPER_CLOUD: ModelConfig(model="nemotron-3-super:cloud", think=True),
    LLMModelEnum.NEMOTRON_CASCADE_2_LATEST: ModelConfig(model="nemotron-cascade-2:latest", think=True),
    LLMModelEnum.NEMOTRON_CASCADE_2_30B: ModelConfig(model="nemotron-cascade-2:30b", think=True),

    # Mistral
    LLMModelEnum.MAGISTRAL_24B: ModelConfig(model="magistral:24b", think=True),

    # Google
    LLMModelEnum.GEMINI_3_FLASH_PREVIEW_LATEST: ModelConfig(model="gemini-3-flash-preview:latest", think=True),
    LLMModelEnum.GEMINI_3_FLASH_PREVIEW_CLOUD: ModelConfig(model="gemini-3-flash-preview:cloud", think=True),

    # OpenAI
    LLMModelEnum.GPT_OSS_20B: ModelConfig(model="gpt-oss:20b", think=True),
    LLMModelEnum.GPT_OSS_SAFEGUARD_LATEST: ModelConfig(model="gpt-oss-safeguard:latest", think=True),
    LLMModelEnum.GPT_OSS_SAFEGUARD_20B: ModelConfig(model="gpt-oss-safeguard:20b", think=True),
    LLMModelEnum.GPT_OSS_SAFEGUARD_120B: ModelConfig(model="gpt-oss-safeguard:120b", think=True),
}
